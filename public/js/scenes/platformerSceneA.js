...
export default class PlatformerSceneA extends Phaser.Scene {
    ...
    preload() {
        ////////////////////PRELOAD GAME ASSETS///////////////////////////////////
        // load background
        this.load.image('backgroundA', './assets/imgs/backgroundA.png')
    ...
    create() {
        ...
        var backgroundScene = this.add.sprite(0, 0, 'backgroundA')
                                 .setOrigin(0,0);
        ...
        this.robo1 = new Robot1(this, roboStop+200, 0, robo1On, roboStop); 
        this.robo2 = new Robot2(this, roboStop+200, 0, robo2On, roboStop);
...
var robotEncounter = function () {
    ...
    this.ratingPanel = new RatingPanel(this, roboStop, 245, trialType, context);
